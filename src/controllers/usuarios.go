...
//SeguirUsuario permite seguir um usuário específico
...
//PararDeSeguirUsuario permite parar de seguir algum usuário
...
// BuscarSeguindo  permite buscar quem o usuário segue
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != tokenID {
		respostas.Erro(w,
			http.StatusForbidden,
			errors.New("Não é permitido atualizar um usuário que não seja o seu"),
		)
		return
	}
